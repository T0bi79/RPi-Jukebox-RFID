...
$lang['globalQuotaEnable'] = "Aktiviere Zeitkontingent-Steuerung";
$lang['globalQuotaDisable'] = "Deaktiviere Zeitkontingent-Steuerung";
$lang['globalQuotaGrant'] = "Kontingent erteilen (in Min.):";
$lang['globalQuotaUnlimited'] = "Kontingent aufheben";
$lang['globalQuotaView'] = "Aktuelle Einstellungen";
$lang['globalQuotaEdit'] = "Einstellung bearbeiten";
$lang['globalQuotaNotify'] = "Nachricht:";
$lang['globalQuotaFrmErr'] = "Der von Dir soeben eingegebene Wert ist ungültig. Bitte beachte den gültigen Bereich für diesen Parameter.";
$lang['globalQ_mu_lbl'] = "Pro LED angezeigte Dauer:";
$lang['globalQ_mu_hlp'] = "Jedes Mal nach dieser Anzahl von Minuten geht 1 LED aus (sofern verwendet). Gib eine Zahl &gt; 0 ein (z.B. 30 für 30 Minuten)";
$lang['globalQ_mu_ph'] = "z.B.. &quot;30&quot;";
$lang['globalQ_dm_lbl'] = "Standard-Kontingent:";
$lang['globalQ_dm_hlp'] = "Anzahl der Minuten, die beim Start der Phoniebox standardmäßig gutgeschrieben werden. Gib eine Zahl &gt; 0 ein (z.B. 120 für 2 Stunden Standardkontingent)";
$lang['globalQ_dm_ph'] = "z.B. &quot;4&quot;";
$lang['globalQ_mr_lbl'] = "Neues Kontingent nach:";
$lang['globalQ_mr_hlp'] = "Zeitspanne (in Minuten) nach der bei Systemstart wieder neues Zeitkontingent gewährt wird (zählt ab dem Zeitpunkt, zu dem das vorige Kontingent gewährt wurde). Gib eine Zahl &gt; 0 ein (z.B. 480 für 6 Stunden bis zur nächsten Kontingentvergabe)";
$lang['globalQ_mr_ph'] = "z.B. &quot;480&quot;";
$lang['globalQ_lg_lbl'] = "LED GPIO-Liste:";
$lang['globalQ_lg_hlp'] = "Komma-getrennte Liste der GPIO-Nummern einer verbauten LED-Reihe (in der gewünschen Anschaltreihenfolge). Leer lassen, um das LED-Feature zu deaktivieren. Verwende nur Zahlen zwischen 2 und 31.";
$lang['globalQ_lg_ph'] = "z.B. &quot;7,8,12,13,19&quot;";
$lang['globalQ_la_lbl'] = "LED Animationsdauer:";
$lang['globalQ_la_hlp'] = "Zeitabstand (in Sekunden) beim animierten Anschalten der LEDs. Beispiel: Wenn du \"0.3\" angibst, wird die zweite LED 300 ms nach der ersten und die dritte LED weitere 300 ms später eingeschaltet. Gib eine Zahl zwischen 0.0 (keine Animation) und 10.0 (10 Sekunden) ein.";
$lang['globalQ_la_ph'] = "z.B. &quot;0.3&quot;";
